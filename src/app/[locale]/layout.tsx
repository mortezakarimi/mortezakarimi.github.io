    ...
    >
      ...
      <body className="mesh-bg flex min-h-full flex-col">
        <NextIntlClientProvider messages={messages}>
          <a
            href="#main"
            className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:m-3 focus:rounded-lg focus:bg-[var(--color-accent)] focus:px-3 focus:py-2 focus:text-[var(--color-background)]"
          >
            Skip to content
          </a>
          <Header />
